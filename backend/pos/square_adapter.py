...
class SquareAdapter(POSAdapter):
    ...
    #                     "code": error.code, 
    #                     "detail": error.detail
    #                 } if hasattr(error, 'category') else str(error)
    #                 for error in result.errors
    #             ]
    #             return response
            
    #         # Extract data from result.body if available
    #         if hasattr(result, 'body'):
    #             body = result.body
    ...
    #             # Handle counts in body
    #             if hasattr(body, 'counts') and body.counts:
    #                 for count in body.counts:
    #                     count_dict = {}
                        
    #                     # Extract all the fields that match Square's response format
    #                     if hasattr(count, 'catalog_object_id'):
    #                         count_dict["catalog_object_id"] = count.catalog_object_id
    #                     if hasattr(count, 'catalog_object_type'):
    #                         count_dict["catalog_object_type"] = count.catalog_object_type
    #                     if hasattr(count, 'state'):
    #                         count_dict["state"] = count.state
    #                     if hasattr(count, 'location_id'):
    #                         count_dict["location_id"] = count.location_id
    #                     if hasattr(count, 'quantity'):
    #                         count_dict["quantity"] = str(count.quantity)  # Ensure it's a string like Square returns
    #                     if hasattr(count, 'calculated_at'):
    #                         count_dict["calculated_at"] = count.calculated_at
    ...
    #         # Handle direct result attributes if no body
    ...
    #                     count_dict["location_id"] = count.location_id
    #                 if hasattr(count, 'quantity'):
    #                     count_dict["quantity"] = str(count.quantity)
    #                 if hasattr(count, 'calculated_at'):
    #                     count_dict["calculated_at"] = count.calculated_at
    ...
    #         # Return the result as-is since Square API returns the correct format
