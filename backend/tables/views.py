...
def table_qr_redirect(request, token):
    ...
    try:
        ...
        if not table:
            ...
            return redirect("http://localhost:8000/QROrderPay?error=invalid_table")
        
        # Build the redirect URL with parameters
        frontend_url = "http://localhost:8000/QROrderPay"
        ...
        return redirect("http://localhost:8000/QROrderPay?error=system_error")
