      ...
      {clientSecret ? (
        <Elements stripe={stripePromise} options={{ clientSecret }}>
          <div className="payment-container">
            ...
            <button className="split-bill-btn">Lets Split The Bill!</button>
            
            <div className="tips-section">
              <p>Add Tips</p>
              <div className="tips-buttons">
                {[5, 10, 15].map((tipAmount) => (
                  <button
                    key={tipAmount}
                    className={`tip-btn ${tip === tipAmount ? 'active' : ''}`}
            ...
            {showStripeForm ? (
              ...
              <div className="payment-methods">
                <GooglePayButton />
                <button className="apple-pay-btn">Apple Pay</button>
              </div>
            )}
          </div>
        </Elements>
